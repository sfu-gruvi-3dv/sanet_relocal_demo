...
''' Configuration ------------------------------------------------------------------------------------------------------
'''
base_dir = '/home/ziqianb/Desktop/7scenes'

seq_name = 'redkitchen/seq-07'
...
in_intrinsic = np.asarray([525.0, 525.0, 324.0, 244.0], dtype=np.float32)
...
def keyPressEvent(obj, event):
    ...
    if key == 'Right':
        ...
        cur_depth = read_7scenese_depth(os.path.join(base_dir, cur_depth_name))
        ...
        vis.add_frame_pose(cur_Tcw[:3, :3], cur_Tcw[:3, 3], camera_obj_scale=0.1)
